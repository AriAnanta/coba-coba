...
//  * @access Private
//  */
// router.post('/machine-update', verifyToken, checkRole(['admin', 'production_manager']), async (req, res) => {
//   try {
//     // Validasi input
...
//  * @access Private
//  */
// router.get('/status', verifyToken, checkRole(['admin', 'production_manager']), (req, res) => {
//   try {
//     return res.status(200).json({
//       success: true,
