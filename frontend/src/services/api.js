...
const machineQueueManagementAPI = createApiInstance(
  BASE_URLS.machineQueueManagement
);
...
export const productionApiService = {
  ...
  getProductionRequests: (params) =>
    productionAPI.get("/production-requests", { params }),
  getProductionRequestById: (id) =>
    productionAPI.get(`/production-requests/${id}`),
  createProductionRequest: (data) =>
    productionAPI.post("/production-requests", data),
  updateProductionRequest: (id, data) =>
    productionAPI.put(`/production-requests/${id}`, data),
  deleteProductionRequest: (id) =>
    productionAPI.delete(`/production-requests/${id}`),
  approveProductionRequest: (id) =>
    productionAPI.put(`/production-requests/${id}/approve`),
  rejectProductionRequest: (id, reason) =>
    productionAPI.put(`/production-requests/${id}/reject`, { reason }),
  ...
  createProductionBatch: (data) =>
    productionAPI.post("/production-batches", data),
  updateProductionBatch: (id, data) =>
    productionAPI.put(`/production-batches/${id}`, data),
  deleteProductionBatch: (id) =>
    productionAPI.delete(`/production-batches/${id}`),
  startProductionBatch: (id) =>
    productionAPI.put(`/production-batches/${id}/start`),
  completeProductionBatch: (id) =>
    productionAPI.put(`/production-batches/${id}/complete`),

  // Production steps
  getProductionSteps: (batchId) =>
    productionAPI.get(`/production-batches/${batchId}/steps`),
  updateProductionStep: (batchId, stepId, data) =>
    productionAPI.put(`/production-batches/${batchId}/steps/${stepId}`, data),

  // Reports
  getProductionReport: (params) =>
    productionAPI.get("/reports/production", { params }),
  getEfficiencyReport: (params) =>
    productionAPI.get("/reports/efficiency", { params }),
};
...
export const machineQueueAPI = {
  ...
  getAllMachines: (params) =>
    machineQueueAPIInstance.get("/machines", { params }),
  ...
  updateMachine: (id, data) =>
    machineQueueAPIInstance.put(`/machines/${id}`, data),
  deleteMachine: (id) => machineQueueAPIInstance.delete(`/machines/${id}`),
  getMachinesByType: (type) =>
    machineQueueAPIInstance.get(`/machines/type/${type}`),
  getMachineTypes: () => machineQueueAPIInstance.get("/machine-types"),
  getMachinesForProduct: (params) =>
    machineQueueAPIInstance.get("/machines-for-product", { params }),
  checkCapacity: (data) =>
    machineQueueAPIInstance.post("/machines/check-capacity", data),
  ...
  getMachineQueue: (machineId) =>
    machineQueueAPIInstance.get(`/machines/${machineId}/queue`),
  getAvailableMachines: () =>
    machineQueueAPIInstance.get("/machines/available"),

  // Queue operations
  startQueueItem: (id, data) =>
    machineQueueAPIInstance.put(`/queues/${id}/start`, data),
  completeQueueItem: (id, data) =>
    machineQueueAPIInstance.put(`/queues/${id}/complete`, data),
  cancelQueueItem: (id, reason) =>
    machineQueueAPIInstance.put(`/queues/${id}/cancel`, { reason }),
  reorderQueue: (id, newPosition) =>
    machineQueueAPIInstance.post(`/queues/${id}/reorder`, { newPosition }),
};

// Machine Queue Management API endpoints
export const machineQueueManagementApiService = {
  // Queue Management
  getAllQueues: () => machineQueueManagementAPI.get("/queues"),
  getQueueById: (id) => machineQueueManagementAPI.get(`/queues/${id}`),
  addToQueue: (data) => machineQueueManagementAPI.post("/queues", data),
  updateQueue: (id, data) =>
    machineQueueManagementAPI.put(`/queues/${id}`, data),
  deleteQueue: (id) => machineQueueManagementAPI.delete(`/queues/${id}`),
  updateQueueStatus: (id, status) =>
    machineQueueManagementAPI.patch(`/queues/${id}/status`, { status }),
  getMachineQueue: (machineId) =>
    machineQueueManagementAPI.get(`/queues/machine/${machineId}`),
  ...
  updateMachine: (id, data) =>
    machineQueueManagementAPI.put(`/machines/${id}`, data),
  deleteMachine: (id) => machineQueueManagementAPI.delete(`/machines/${id}`),
  updateMachineStatus: (id, status) =>
    machineQueueManagementAPI.patch(`/machines/${id}/status`, { status }),
};
...
export const materialInventoryApiService = {
  ...
  updateMaterial: (id, data) =>
    materialInventoryAPI.put(`/materials/${id}`, data),
  ...
  updateSupplier: (id, data) =>
    materialInventoryAPI.put(`/suppliers/${id}`, data),
  deleteSupplier: (id) => materialInventoryAPI.delete(`/suppliers/${id}`),

  // Transactions
  getTransactions: (params) =>
    materialInventoryAPI.get("/transactions", { params }),
  ...
  updateTransaction: (id, data) =>
    materialInventoryAPI.put(`/transactions/${id}`, data),

  // Stock operations
  addStock: (materialId, data) =>
    materialInventoryAPI.post(`/materials/${materialId}/add-stock`, data),
  reduceStock: (materialId, data) =>
    materialInventoryAPI.post(`/materials/${materialId}/reduce-stock`, data),
  checkStock: (materialId) =>
    materialInventoryAPI.get(`/materials/${materialId}/stock`),

  // Reports
  getInventoryReport: (params) =>
    materialInventoryAPI.get("/reports/inventory", { params }),
...
export const productionFeedbackApiService = {
  ...
  updateFeedback: (id, data) =>
    productionFeedbackAPI.put(`/feedback/${id}`, data),
  deleteFeedback: (id) => productionFeedbackAPI.delete(`/feedback/${id}`),

  // Quality checks
  getQualityChecks: (params) =>
    productionFeedbackAPI.get("/quality-checks", { params }),
  getQualityCheckById: (id) =>
    productionFeedbackAPI.get(`/quality-checks/${id}`),
  createQualityCheck: (data) =>
    productionFeedbackAPI.post("/quality-checks", data),
  updateQualityCheck: (id, data) =>
    productionFeedbackAPI.put(`/quality-checks/${id}`, data),
  deleteQualityCheck: (id) =>
    productionFeedbackAPI.delete(`/quality-checks/${id}`),

  // Reports
  getQualityReport: (params) =>
    productionFeedbackAPI.get("/reports/quality", { params }),
  getPerformanceReport: (params) =>
    productionFeedbackAPI.get("/reports/performance", { params }),
};
